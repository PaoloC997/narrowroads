        ...
        <div class="d-flex">
            <div class="d-flex-left">
                <p class="grotesk"> When I enter the room, the first image that greets me is Ginebra Raventós, Ɇ₥łⱠłØ
                    ...
                    from
                    Japanese, a language where context is crucial, in which each kanji can visually describe multiple
                    concepts,
                    involves the death and rebirth of the poem, transforming it into something similar, but almost.
                    Octavio Paz
            ...
            <div class="d-flex-right">
                ...
                <p class="grotesk">Similarly, just as in haikus the poet's identity fades in favor of the landscape,
                    ...
                    sensations
                    awakened.
                    Acoustic Heritage Collective impacts us visually in an immersive environment, guiding us into
                    silence and
                    stillness, immersing us in the altered state of consciousness that comes with traveling to an
                    unknown land,
                    attempting to tell us their memory of the journey, a memory composed of many voices. With the same
                    kamikaze
                    intent as one who tries to translate something untranslatable, something that can only be lived
                    through
                    experience. Memory, translation, the trap.
                    When all signs point to the fact that we cannot understand it all, the best thing is to surrender to
                    feeling. In their attempt, let us be carried away by the senses.”</p>
            </div>
        </div>
    </div>
</template>
